...
import heat from "../../assets/chart.png";
          ...
          <div className="hero">
            <div className="Phone">
              <div className="dec">
                ...
                <div className="dropdown">
                  ...
                  <div
                    className={
                      isOpen ? "dropdown-content active" : "dropdown-content"
                    }
                  >
                    ...
                    <hr />
                    <div className="type">
                      <h5>Технология изготовления экрана</h5>
                      <span> OLED</span>
                    </div>
                    <hr />
                    <div className="type">
                    ...
                    <hr />
                    <div className="type">
                      <h5>Конструктивные особенности экрана</h5>
                      <span> безрамочный вырез на экрана</span>
                    </div>
                    <hr />
                    <br />
                    <h5>Заводские данные</h5>
              ...
              <div className="titleText">
                ...
                <p className="desck">
                  ...
                  по стандарту IP68. Мощный чип A15 Bionic обеспечивает быструю
                  и стабильную работу при запуске приложений, просмотре видео,
                  веб-серфинге и выполнении других задач. На дисплее 6.1 дюйма
                  OLED выводится четкая и красочная картинка. На тыловой стороне
                  расположена камера с двумя датчиками по 12 Мп, которые при
                  поддержке ряда технологий и функций позволяют создавать
                  реалистичные снимки в различных условиях. На передней стороне
                  имеется камера 12 Мп для селфи и общения. В мобильном
                  устройстве предлагается широкий набор беспроводных интерфейсов
                  и разъем Lightning 8-pin. Аккумулятор гарантирует
                  продолжительное время автономности. Из особенностей отмечаются
                  поддержка быстрой зарядки, беспроводной зарядки и устройств
            ...
            <div className="Store">
              <div className="Store_component">
                ...
                <div className="Type">
                  {progress.map((label, idx) => (
                    <div key={idx} className="ddd">
                      <h4 className="desing">{label.title}</h4>
                ...
                <h5 className="dostavka">Доставка бесплатная</h5>
                <div className="Css">
              ...
              <div className="Uroven_grafic">
                <div className="histori">
                  ...
                  <img className="chart1" src={chart1} alt="" />
                  <div className="Shop">
